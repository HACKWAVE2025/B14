        ...
        <div className="pixel-box p-8 space-y-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <Link
                to="/forgot-password"
                className="text-sm text-pink-500 hover:text-cyan-300"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <Button className="btn-pixel-alt w-full" size="lg" disabled={loading}>
            <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
              {/* Google icon path colors changed to white/cyan */}
              <path
                fill="currentColor"
